...
(function () {
  ...
  function initLangToggle() {
    ...
    function getPreferredLang() {
      ...
      return navigator.language && navigator.language.startsWith("de")
        ? "de"
        : DEFAULT_LANG;
    }
    ...
    function applyLang(lang) {
      ...
      if (path.endsWith("impressum.html")) {
        document.title =
          lang === "de"
            ? "Impressum — KoalaClicker"
            : "Legal Notice — KoalaClicker";
      } else if (path.endsWith("datenschutz.html")) {
        document.title =
          lang === "de"
            ? "Datenschutzerklärung — KoalaClicker"
            : "Privacy Policy — KoalaClicker";
      } else {
        document.title =
          lang === "de"
  ...
  function initVersionLabels() {
    const version = document.querySelector(
      'meta[name="koalaclicker-version"]',
    )?.content;
    if (!version) return;
